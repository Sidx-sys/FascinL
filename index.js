...
let counter = 0;
let themeSolar = '<li class="nav-item" id="themeButton">' +
    ...
    '<path fill="currentColor" d="M352 256a96 96 0 1 1-96-96 96.15 96.15 0 0 1 96 96z" class="fa-primary"></path> </g> </svg>' +
    '<span class="link-text">Themify</span>' +
    '</a></li>';
let themeDark = '<li class="nav-item" id="themeButton">' +
    '<a href="#" class="nav-link">' +
    ...
    '<span class="link-text">Themify</span>' +
    '</a></li>';
let themeLight = '<li class="nav-item" id="themeButton">' +
    '<a href="#" class="nav-link">' +
    ...
    '<span class="link-text">Themify</span>' +
    '</a></li>';
// Just need to change the primary / secondary colors
// and change the icon for theme
let button = document.querySelector('#themeButton');
button.addEventListener("click", () => {
    counter = (++counter) % 3;
    if (counter == 0) {
        list.removeChild(list.children[5]);
        list.innerHTML += themeDark;
    } else if (counter == 1) {
        list.removeChild(list.children[5]);
        list.innerHTML += themeLight;
    } else {
        list.removeChild(list.children[5]);
        list.innerHTML += themeSolar;
    }
    console.log(counter);
});